...
from custom_sam_scripts.utils.sam2_utils.get_sam_for_video_inference import get_sam_for_video_inference
from custom_sam_scripts.utils.drawing_utils.save_sam2_masks import save_results
from custom_sam_scripts.utils.drawing_utils.add_interactive_frame import interactive_frame_annotation
...
def run_sam_on_video_frames(
    ...
    **kwargs,
    ...
    # Set the inference state (here SAM2 will read and load all frames in the video)
    ...
    points, neg_points, bboxes = interactive_frame_annotation(first_frame, sam2, inference_state)
