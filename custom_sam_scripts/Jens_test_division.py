...
def plot_and_save_images(images, titles, save_dir):
    """
...
def main(img1_path, img2_path, save_dir):
    # Load images
    ...
    img_1_over_img2_normalized = normalize_image(img1_over_img2)
    img_2_over_img1_normalized = normalize_image(img2_over_img1)
    ...
    images = [
        ...
        [img_1_over_img2_normalized, img_2_over_img1_normalized]
    ]
    titles = [
    ...
    plot_and_save_images(images, titles, save_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--img1_path", default="/Image_Datasets/InfuSight/ENCXYN/SHL01/image_1.jpeg", help="Path to the first image")
    parser.add_argument("--img2_path", default="/Image_Datasets/InfuSight/ENCXYN/SHL01/image_2.jpeg", help="Path to the second image")
    parser.add_argument("--save_dir", default=None, help="Directory to save the output plot")
    args = parser.parse_args()

    # Set default save_dir if not provided
    if args.save_dir is None:
        args.save_dir = os.path.dirname(os.path.commonprefix([args.img1_path, args.img2_path]))

    # Print the arguments
    print_args(args, init_str="This is the input args chosen when running Jens' preprocessing script")

    # Run the main function
    main(args.img1_path, args.img2_path, args.save_dir)
